...
list<Event*>* Scheduler::get_event_schedule() {

	return &this->event_schedule;
}

int Scheduler::add_event(Event *input_event) {
...
int Scheduler::remove_event(long int eventID) {
...
int Scheduler::create_new_event() {
...
int Scheduler::delete_existing_event() {
...
void Scheduler::print_event_schedule() {
...
Event* Scheduler::check_overdueEvents() { // Scans event_schedule and returns the first overdue Event it finds.
	...
	for (list<Event*>::const_reverse_iterator iterator = event_schedule.rbegin(); iterator != event_schedule.rend(); iterator++)
	{
		...
		temp = *iterator; // Couldn't figure out how to access list elements directly from reverse_iterator so doing this instead...
...
int Scheduler::process_overdueEvents(Event *input_event) {
...
Image_Processor* Scheduler::get_image_processor() {

	return this->frame_processor;
}

Response_Module* Scheduler::get_response_module() {

	return this->responder;
}

int Scheduler::display_camera_feed() {
...
VideoCapture* Scheduler::get_camera() {

	return  &this->camera;
}

int Scheduler::scheduler_execution_cycle() {

...
time_t Event::get_execution_deadline() {

	return this->execution_deadline;
}

time_t Event::get_event_creation_time() {

	return this->event_creation_time;
}

void Event::set_eventID(long int input_eventID) {

	this->eventID = input_eventID;
}

long int Event::get_eventID() {

	return this->eventID;
}

string Event::get_eventName() {

	return this->event_name;
}


int Event::get_event_priority() {
...
int SurveillancePhoto::execute_event(VideoCapture input_cap, int camera_index, string save_directory) {
...
int SurveillanceVideo::execute_event(VideoCapture input_cap, int camera_index, string save_directory) {
	...
	{
		double dWidth = input_cap.get(CV_CAP_PROP_FRAME_WIDTH);
		double dHeight = input_cap.get(CV_CAP_PROP_FRAME_HEIGHT);
